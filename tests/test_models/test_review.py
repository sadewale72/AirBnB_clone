#!/usr/bin/python3
"""This module tests review.py file.
Usage:
...
class TestReview01(unittest.TestCase):
    """Tests to check the documentation of Review class"""
    @classmethod
    def setUpClass(cls):
...
class TestReview02(unittest.TestCase):
